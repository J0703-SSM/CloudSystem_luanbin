            ...
            <form action="" method="">
                ...
                <div id="data">            
                    <table id="datalist">
                        ...
                        <c:forEach items="${extAdmins}" var="extAdmin">
                        <tr>
                            <td><input type="checkbox" /></td>
                            <td>${extAdmin.id}</td>
                            <td>${extAdmin.name}</td>
                            <td>${extAdmin.admin_code}</td>
                            <td>${extAdmin.telephone}</td>
                            <td>${extAdmin.email}</td>
                            <td>${extAdmin.enrolldate}</td>
                            <td>
                                <a class="summary"  onmouseover="showDetail(true,this);" onmouseout="showDetail(false,this);">
                                    <c:if test="${extAdmin.role_names == null}">
                                        暂无角色
                                    </c:if>
                                    <c:forEach items="${extAdmin.strings}" var="string" varStatus="vs">
