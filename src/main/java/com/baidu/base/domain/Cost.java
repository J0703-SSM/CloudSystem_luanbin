...
public class Cost {
    ...
    public Cost(Integer id, String name, Integer base_duration, Double base_cost, Double unit_cost, String status, String descr, Date creatime, Date startime, String cost_type) {
        this.id = id;
        this.name = name;
